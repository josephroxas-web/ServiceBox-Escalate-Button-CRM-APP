(function(require$$0, react) {
  ...
  hubspot.extend(({ context, actions }) => /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
    EscalateCard,
    {
      context,
      actions
    ...
    false,
    {
      fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
      lineNumber: 57,
      columnNumber: 3
    },
    void 0
  ));
  async function callFn(parameters) {
    return hubspot.serverless("servicebox_escalation_app_function", { parameters });
  }
  const EscalateCard = ({ context, actions }) => {
    var _a;
    const ticketId = (_a = context.crm) == null ? void 0 : _a.objectId;
    const [view, setView] = require$$0.useState("intro");
    const [status, setStatus] = require$$0.useState("idle");
    const [errorMsg, setErrorMsg] = require$$0.useState(null);
    const [fields, setFields] = require$$0.useState([]);
    const [values, setValues] = require$$0.useState({});
    const [escalationInfo, setEscalationInfo] = require$$0.useState(null);
    require$$0.useEffect(() => {
      callFn({ action: "status", ticketId }).then((resp) => {
        var _a2;
        if ((_a2 = resp == null ? void 0 : resp.body) == null ? void 0 : _a2.escalatedTicketId) {
    ...
    const openForm = async () => {
      ...
      try {
        ...
        if (resp.statusCode !== 200) {
          throw new Error(((_a2 = resp.body) == null ? void 0 : _a2.error) || "Failed to load escalation form.");
        }
        ...
        setErrorMsg((e == null ? void 0 : e.message) || "Could not load form.");
        setStatus("error");
      }
    };
    const submitEscalation = async () => {
      ...
      try {
        ...
        if (resp.statusCode !== 200) {
          throw new Error(((_a2 = resp.body) == null ? void 0 : _a2.error) || "Escalation failed.");
        }
        setEscalationInfo({
        ...
        setStatus("success");
        setView("intro");
        (_b = actions.refreshObjectProperties) == null ? void 0 : _b.call(actions);
      } catch (e) {
        setErrorMsg((e == null ? void 0 : e.message) || "Escalation failed.");
        setStatus("error");
      }
    };
    const setValue = (name, v) => setValues((prev) => ({ ...prev, [name]: v }));
    if (escalationInfo == null ? void 0 : escalationInfo.escalatedTicketId) {
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "sm", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Alert, { title: "Escalation Ticket Created", variant: "info", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "row", align: "center", gap: "xs", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: "Linked ticket:" }, void 0, false, {
            fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
            lineNumber: 162,
            columnNumber: 13
          }, void 0),
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { format: { fontWeight: "bold" }, children: [
            "#",
        ...
        escalationInfo.incidentTicketId && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Alert, { title: "Incident Triggered", variant: "warning", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "xs", children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "row", align: "center", gap: "xs", children: [
            /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { children: "Incident ticket:" }, void 0, false, {
              fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
              lineNumber: 172,
              columnNumber: 17
            }, void 0),
            ...
            escalationInfo.severity && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { format: { fontWeight: "bold" }, children: [
              "(",
          ...
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { variant: "microcopy", children: "Per SOP: incident creation is forward-only — close the incident if it was opened in error; the escalation ticket remains." }, void 0, false, {
            fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
            lineNumber: 182,
            columnNumber: 15
          }, void 0)
    ...
    if (view === "form") {
      return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "md", children: [
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { format: { fontWeight: "bold" }, children: "Technical escalation" }, void 0, false, {
          fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
          lineNumber: 197,
          columnNumber: 9
        }, void 0),
        ...
        errorMsg && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Alert, { title: "Error", variant: "error", children: errorMsg }, void 0, false, {
          fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
          lineNumber: 201,
          columnNumber: 11
        }, void 0),
        ...
        /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(ButtonRow, { children: [
          /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
            Button,
            {
              ...
              children: status === "submitting" ? "Escalating…" : "Submit escalation"
            },
            void 0,
            false,
            {
    ...
    return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Flex, { direction: "column", gap: "sm", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Text, { variant: "microcopy", children: "Send this ticket to the technical triage queue. A linked TET will be created; closing either side closes the other." }, void 0, false, {
        fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
        lineNumber: 294,
        columnNumber: 7
      }, void 0),
      ...
      status === "success" && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(Alert, { title: "Escalated", variant: "success", children: "Linked ticket created and associated." }, void 0, false, {
        fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
        lineNumber: 306,
        columnNumber: 9
      }, void 0),
      status === "loading-form" && /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(LoadingSpinner, { label: "Loading form" }, void 0, false, {
        fileName: "E:/Hubspot_work/ServiceBox-Escalate-Button-CRM-APP/servicebox-escalation/src/app/cards/EscalateCard.tsx",
        lineNumber: 311,
        columnNumber: 37
      }, void 0),
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
        Button,
        {
          ...
          children: status === "loading-form" ? "Loading form…" : "Escalate"
        },
        void 0,
        false,
        {
